...
@csrf
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="product_name" required="required" name="name" class="form-control col-md-7 col-xs-12" placeholder="Product Name">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="product_price" required="required" name="price" class="form-control col-md-7 col-xs-12" placeholder="Product Price">
              </div>
            </div>
            <div class="form-group">
